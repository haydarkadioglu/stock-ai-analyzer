...
const translations = {
    tr: {
        ...
        howToGetApiKey: 'API anahtarı nasıl alınır?',
        apiKeyHelpTitle: 'Gemini API Anahtarı Nasıl Alınır?',
        apiKeyHelpStep1Title: 'Google AI Studio\'yu Ziyaret Edin',
        apiKeyHelpStep1Desc: '<a href="https://aistudio.google.com/app/apikey" target="_blank">Google AI Studio</a> sayfasına gidin ve Google hesabınızla giriş yapın.',
        apiKeyHelpStep2Title: 'API Anahtarı Oluşturun',
        apiKeyHelpStep2Desc: '"Create API Key" (API Anahtarı Oluştur) butonuna tıklayın ve "Create API key in new project" (Yeni projede API anahtarı oluştur) seçeneğini veya mevcut bir projeyi seçin.',
        apiKeyHelpStep3Title: 'API Anahtarınızı Kopyalayın',
        apiKeyHelpStep3Desc: 'API anahtarı oluşturulduktan sonra görüntülenecektir. Hemen kopyalayın çünkü bir daha gösterilmeyecektir.',
        apiKeyHelpStep4Title: 'Yapıştırın ve Kaydedin',
        apiKeyHelpStep4Desc: 'API anahtarınızı yukarıdaki input alanına yapıştırın ve "Ayarları Kaydet" butonuna tıklayın. Kaydetmeden önce "Test" butonunu kullanarak test edebilirsiniz.',
        apiKeyHelpNote: 'API anahtarınızı güvende tutun ve asla herkese açık paylaşmayın. Gerekirse Google AI Studio\'dan API anahtarlarınızı iptal edip yeniden oluşturabilirsiniz.',
        apiKeyHelpNoteTitle: 'Önemli Not',
        apiKeyHelpSubtitle: 'Google AI Studio\'dan Gemini API anahtarınızı almak için adım adım kılavuz',
        apiKeyHelpOpenStudio: 'Google AI Studio\'yu Aç',
    ...
    en: {
        ...
        apiKeyHelpTitle: 'How to Get Gemini API Key',
        apiKeyHelpStep1Title: 'Visit Google AI Studio',
        apiKeyHelpStep1Desc: 'Go to <a href="https://aistudio.google.com/app/apikey" target="_blank">Google AI Studio</a> and sign in with your Google account.',
        apiKeyHelpStep2Title: 'Create API Key',
        apiKeyHelpStep2Desc: 'Click on "Create API Key" button and select "Create API key in new project" or choose an existing project.',
        apiKeyHelpStep3Title: 'Copy Your API Key',
        apiKeyHelpStep3Desc: 'Once created, your API key will be displayed. Copy it immediately as it won\'t be shown again.',
        apiKeyHelpStep4Title: 'Paste and Save',
        apiKeyHelpStep4Desc: 'Paste your API key in the input field above and click "Save Settings". You can test it before saving using the "Test" button.',
        apiKeyHelpNote: 'Keep your API key secure and never share it publicly. You can revoke and regenerate API keys from Google AI Studio if needed.',
        apiKeyHelpNoteTitle: 'Important Note',
        apiKeyHelpSubtitle: 'Step-by-step guide to get your Gemini API key from Google AI Studio',
        apiKeyHelpOpenStudio: 'Open Google AI Studio',
